            ...
            {timeline.map((item, index) => (
              <AnimatedSection key={item.week} delay={index * 0.1}>
                ...
                >
                  ...
                  >
                      <div className="flex items-center gap-2 mb-2 flex-wrap md:justify-inherit">
                        <span className="inline-block text-purple-600 font-bold text-sm">
                          WEEK {item.week}
                        </span>
                        <span className="text-gray-400 text-sm">·</span>
                        <span className="inline-block text-gray-500 font-medium text-sm">
                          {item.date}
                        </span>
                      </div>
